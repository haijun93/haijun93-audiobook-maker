...
MANUAL_CATEGORY_HINTS = (
    ...
    ("dark notes", "Dark_Romance"),
    ("haunting adeline", "Dark_Romance"),
    ("does it hurt", "Dark_Romance"),
    ("lights out", "Dark_Romance"),
    ("the deal", "Dark_Romance"),
    ("elle kennedy", "Dark_Romance"),
    ("navessa allen", "Dark_Romance"),
    ("wicked sanctuary", "Dark_Romance"),
    ("vicious reign", "Dark_Romance"),
    ("bethany jadin", "Dark_Romance"),
    ...
    ("quicksilver", "Dark_Romance"),
    ("callie hart", "Dark_Romance"),
    ("nicholas sparks", "Dark_Romance"),
    ("counting miracles", "Dark_Romance"),
    ("obedience", "Dark_Romance"),
    ("initial meeting", "Dark_Romance"),
    ("shadows of fury", "Dark_Romance"),
)
